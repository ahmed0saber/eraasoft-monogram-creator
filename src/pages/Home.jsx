            ...
            <form onSubmit={generateMonogram} className='w-100'>
                <div className='row my-0 row-gap-3'>
                    ...
                    <div className='col-sm-6'>
                        ...
                        <input ref={textColorRef} type="color" className="form-control" id="text_color" placeholder="Enter text color here" />
                    </div>
                    <div className='col-sm-6'>
                        <label htmlFor="background_color" className="form-label mb-1">Background Color</label>
                        <input ref={backgroundColorRef} type="color" className="form-control" id="background_color" placeholder="Enter background color here" />
                    </div>
                </div>
